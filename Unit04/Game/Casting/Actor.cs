...
namespace Unit04.Game.Casting
{
    ...
    public class Actor
    {
        ...
        private Point velocity2 = new Point(0, 0);
        ...
        {
            int x = ((position.GetX() + velocity.GetX() + velocity2.GetX()) + maxX) % maxX;
            int y = ((position.GetY() + velocity.GetY() + velocity2.GetY()) + maxY) % maxY;
        ...
        public void SetVelocity2(Point velocity2)
        {
            if (velocity2 == null)
            {
                throw new ArgumentException("velocity can't be null");
